...
const setBroadcastlessStudies = async (
  token: string,
  username: string,
  setStudies: any,
  broadcasts: any,
...
export const lichessSetStudies = (
  token: string,
  setStudies: any,
  username: string,
...
export const lichessImportPgnToStudy = (
  token: string,
  pgn: string,
  name: string,
  studyId: string,
...
export const lichessStreamGame = (
  token: string,
  callback: any,
  gameId: string,
) => {
  const path = `/api/board/game/stream/${gameId}`;
  fetchResponse(token, path).then(readStream(callback));
};
...
export const lichessTrySetUser = async (
